...
Shop.Chests = 
{
	...
	["501"] = {{{818,25},{24,25},{117,25},{130,25},{116,25},{602,25},{603,50}}, 	{"gold", 25, {10, 50} } },
	["502"] = {{{819,25},{25,25},{118,25},{131,25},{602,25},{603,25},{604,50}}, 	{"gold", 25, {15, 75} } },
	["503"] = {{{822,25},{26,25},{119,25},{114,25},{115,25},{605,25},{606,50}}, 	{"gold", 25, {10, 50} } },
	["504"] = {{{801,25},{836,25},{20,25},{120,25},{111,25},{605,25},{606,25},{607,50}}, 	{"gold", 25, {15, 75} } },
	["505"] = {{{802,25},{838,25},{21,25},{122,25},{112,25},{606,25},{607,25},{608,50}}, 	{"gold", 25, {15, 75} } },
	["506"] = {{{803,25},{41,25},{31,25},{35,25},{103,25},{607,25},{613,25},{609,50}}, 	    {"gold", 25, {20, 100} } },
	["507"] = {{{804,25},{36,25},{37,25},{19,25},{129,25},{113,25},{615,25},{612,50}}, 	    {"gold", 25, {25, 125} } },
	["508"] = {{{805,25},{29,25},{39,25},{28,25},{132,25},{615,25},{612,25},{616,50}}, 	    {"gold", 25, {30, 150} } },
	["509"] = {{{806,25},{5,25},{10,25},{32,25},{133,25},{614,25},{616,25},{617,50}}, 	    {"gold", 25, {35, 150} } },
	["510"] = {{{807,25},{6,25},{38,25},{127,25},{134,25},{46,25},{635,25},{636,50}}, 	    {"gold", 25, {40, 200} } },
	["511"] = {{{810,25},{7,25},{40,25},{128,25},{135,25},{47,25},{637,25},{638,50}}, 	    {"gold", 25, {40, 200} } },
	["512"] = {{{811,25},{8,25},{42,25},{126,25},{144,25},{48,25},{639,25},{640,50}}, 	    {"gold", 25, {45, 200} } },
	["513"] = {{{813,25},{9,25},{43,25},{124,25},{146,25},{49,25},{641,25},{642,50}}, 	    {"gold", 25, {45, 200} } },
	--66
	["514"] = {{{614,25},{602,25},{603,25},{604,25},{605,25},{606,25},{607,25},{608,25},{609,50}}, 	{"gold", 25, {50, 250} } },
	["515"] = {{{615,25},{612,25},{616,25},{617,25},{613,25},{639,25},{640,25},{641,25},{642,50}}, 	{"gold", 25, {50, 250} } },
	--wolf 31
	["516"] = {{{701,25},{814,25},{827,25},{18,25},{46,25},{133,25},{134,25},{624,25},{621,50}}, 	{"gold", 25, {10, 50} } },
	["517"] = {{{702,25},{816,25},{833,25},{23,25},{115,25},{135,25},{624,25},{621,25},{622,50}}, 	{"gold", 25, {15, 75} } },
	["518"] = {{{703,25},{722,25},{834,25},{27,25},{47,25},{50,25},{621,25},{622,25},{627,50}}, 	    {"gold", 25, {20, 100} } },
	["519"] = {{{715,25},{721,25},{44,25},{22,25},{48,25},{51,25},{623,25},{628,25},{625,50}}, 	    {"gold", 25, {25, 100} } },
	["520"] = {{{714,25},{718,25},{45,25},{34,25},{52,25},{610,25},{611,25},{629,25},{626,50}}, 	    {"gold", 25, {35, 150} } },
	["521"] = {{{620,25},{624,25},{621,25},{622,25},{627,25},{628,25},{625,25},{629,25},{626,50}},   {"gold", 25, {40, 200} } },
	["522"] = {{{808,25},{809,25},{825,25},{33,25},{53,25},{54,25},{55,25},{618,25},{619,50}},       {"gold", 25, {45, 200} } },
	--["523"] = {{{802,99},{111,99},{112,99},{113,99},{114,99},{115,99},{116,99},{103,99},{127,99}},    {"gold", 25, {10, 100} } },
	--bear 
	["524"] = {{{673,25},{680,25},{682,25},{674,25},{675,25},{678,25},{679,25},{677,25},{681,50}},   {"gold", 25, {40, 250} } },
	["525"] = {{{654,25},{669,25},{668,25},{667,25},{656,25},{660,25},{659,25},{662,25},{663,50}},   {"gold", 25, {200, 2000} } }
}
...
Shop.donate_rewards = {
    ...
    {"1",   "517", "chest_17", 1, "1"},
    {"2",   "999999", "gem_icon", 110, "2"},
    {"3",   "999999", "gem_icon", 120, "3"},
    {"4",   "999999", "gem_icon", 140, "4"},
    {"5",   "999999", "gem_icon", 150, "5"},
    {"6",   "999999", "gem_icon", 160, "6"},
    {"7",   "999999", "gem_icon", 170, "7"},
    {"8",   "999999", "gem_icon", 180, "8"},
    {"9",   "999999", "gem_icon", 190, "9"},
    {"10",  "505", "chest_5",  1,   "10"},
    {"11",  "999999", "gem_icon", 200, "11"},
    {"12",  "999999", "gem_icon", 210, "12"},
    {"13",  "999999", "gem_icon", 220, "13"},
    {"14",  "999999", "gem_icon", 230, "14"},
    {"15",  "999999", "gem_icon", 240, "15"},
    {"16",  "999999", "gem_icon", 250, "16"},
    {"17",  "999999", "gem_icon", 260, "17"},
    {"18",  "999999", "gem_icon", 270, "18"},
    {"19",  "999999", "gem_icon", 280, "19"},
    {"20",  "503", "chest_18", 1,   "20"},
    {"21",  "999999", "gem_icon", 340, "21"},
    {"22",  "999999", "gem_icon", 360, "22"},
    {"23",  "999999", "gem_icon", 370, "23"},
    {"24",  "999999", "gem_icon", 380, "24"},
    {"25",  "516", "chest_6",  1,   "25"},
    {"26",  "999999", "gem_icon", 410, "26"},
    {"27",  "999999", "gem_icon", 420, "27"},
    {"28",  "999999", "gem_icon", 430, "28"},
    {"29",  "999999", "gem_icon", 440, "29"},
    {"30",  "519", "chest_19", 1,   "30"},
    {"31",  "999999", "gem_icon", 470, "31"},
    {"32",  "999999", "gem_icon", 480, "32"},
    {"33",  "999999", "gem_icon", 490, "33"},
    {"34",  "999999", "gem_icon", 500, "34"},
    {"35",  "502", "chest_2",  1,   "35"},
    {"36",  "999999", "gem_icon", 530, "36"},
    {"37",  "999999", "gem_icon", 540, "37"},
    {"38",  "999999", "gem_icon", 550, "38"},
    {"39",  "999999", "gem_icon", 570, "39"},
    {"40",  "507", "chest_7",  1,   "40"},
    {"41",  "999999", "gem_icon", 590, "41"},
    {"42",  "999999", "gem_icon", 600, "42"},
    {"43",  "999999", "gem_icon", 610, "43"},
    {"44",  "999999", "gem_icon", 630, "44"},
    {"45",  "508", "chest_8",  1,   "45"},
    {"46",  "999999", "gem_icon", 650, "46"},
    {"47",  "999999", "gem_icon", 660, "47"},
    {"48",  "999999", "gem_icon", 680, "48"},
    {"49",  "999999", "gem_icon", 690, "49"},
    {"50",  "509", "chest_9",  1,   "50"},
}
...
Shop.free_rewards = {
    ...
    {"1",   "999999", "gem_icon", 100, "1001"},
    {"2",   "999999", "gem_icon", 110, "1002"},
    {"3",   "999999", "gem_icon", 120, "1003"},
    {"4",   "999999", "gem_icon", 140, "1004"},
    {"5",   "999999", "gem_icon", 150, "1005"},
    {"6",   "999999", "gem_icon", 160, "1006"},
    {"7",   "999999", "gem_icon", 170, "1007"},
    {"8",   "999999", "gem_icon", 180, "1008"},
    {"9",   "999999", "gem_icon", 190, "1009"},
    {"10",  "501", "chest_1",  1,   "1010"},
    {"11",  "999999", "gem_icon", 200, "1011"},
    {"12",  "999999", "gem_icon", 210, "1012"},
    {"13",  "999999", "gem_icon", 220, "1013"},
    {"14",  "999999", "gem_icon", 230, "1014"},
    {"15",  "999999", "gem_icon", 240, "1015"},
    {"16",  "999999", "gem_icon", 250, "1016"},
    {"17",  "999999", "gem_icon", 260, "1017"},
    {"18",  "999999", "gem_icon", 270, "1018"},
    {"19",  "999999", "gem_icon", 280, "1019"},
    {"20",  "503", "chest_3",  1,   "1020"},
    {"21",  "999999", "gem_icon", 340, "1021"},
    {"22",  "999999", "gem_icon", 360, "1022"},
    {"23",  "999999", "gem_icon", 370, "1023"},
    {"24",  "999999", "gem_icon", 380, "1024"},
    {"25",  "999999", "gem_icon", 390, "1025"},
    {"26",  "999999", "gem_icon", 410, "1026"},
    {"27",  "999999", "gem_icon", 420, "1027"},
    {"28",  "999999", "gem_icon", 430, "1028"},
    {"29",  "999999", "gem_icon", 440, "1029"},
    {"30",  "516", "chest_16", 1,   "1030"},
    {"31",  "999999", "gem_icon", 470, "1031"},
    {"32",  "999999", "gem_icon", 480, "1032"},
    {"33",  "999999", "gem_icon", 490, "1033"},
    {"34",  "999999", "gem_icon", 500, "1034"},
    {"35",  "999999", "gem_icon", 520, "1035"},
    {"36",  "999999", "gem_icon", 530, "1036"},
    {"37",  "999999", "gem_icon", 540, "1037"},
    {"38",  "999999", "gem_icon", 550, "1038"},
    {"39",  "999999", "gem_icon", 570, "1039"},
    {"40",  "502", "chest_2",  1,   "1040"},
    {"41",  "999999", "gem_icon", 590, "1041"},
    {"42",  "999999", "gem_icon", 600, "1042"},
    {"43",  "999999", "gem_icon", 610, "1043"},
    {"44",  "999999", "gem_icon", 630, "1044"},
    {"45",  "999999", "gem_icon", 640, "1045"},
    {"46",  "999999", "gem_icon", 650, "1046"},
    {"47",  "999999", "gem_icon", 660, "1047"},
    {"48",  "999999", "gem_icon", 680, "1048"},
    {"49",  "999999", "gem_icon", 690, "1049"},
