modifier_worker_spell_cd_reduce_x4 = class({})
function modifier_worker_spell_cd_reduce_x4:IsPurgable()         return false end
function modifier_worker_spell_cd_reduce_x4:IsPurgeException()   return false end
function modifier_worker_spell_cd_reduce_x4:RemoveOnDeath()      return true end
