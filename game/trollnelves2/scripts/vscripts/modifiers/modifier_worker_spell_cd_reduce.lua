modifier_worker_spell_cd_reduce = class({})
function modifier_worker_spell_cd_reduce:IsPurgable()         return false end
function modifier_worker_spell_cd_reduce:IsPurgeException()   return false end
function modifier_worker_spell_cd_reduce:RemoveOnDeath()      return true end
