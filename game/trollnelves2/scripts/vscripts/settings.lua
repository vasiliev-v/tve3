...
PERCENT_FOR_COST_ASPECT = 0.35
BASE_COST_ASPECT_RANDOM = 1000
...
dedicatedServerKey = "WHAT THE FUCK YOU MEDDLING FOR NOT YOUR BIZ"   -- GetDedicatedServerKeyV3("1")  -- "WHAT THE FUCK YOU MEDDLING FOR NOT YOUR BIZ" 