...
function InitializeBuilder(hero)
    ...
    Timers:CreateTimer(function()
        ...
        if hero:IsAngel() or hero:IsWolf() or hero:IsTroll()  then
            return
        end
