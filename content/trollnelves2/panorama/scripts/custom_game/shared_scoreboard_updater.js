		...
		if ( playerPortrait )
		{
			...
			if ( playerInfo.player_selected_hero !== "" )
			{
				...
				if (donatePanel[playerId] != localPlayerTeamId && player_table != null)
				{
					...
					{
						$.CreatePanelWithProperties("DOTAParticleScenePanel", playerPortrait, "RevengeTargetFrame", { style: "width:100%;height:100%;", particleName: "particles/donate/gold_icon_bp_3.vpcf", particleonly:"true", startActive:"true", cameraOrigin:"0 0 165", lookAt:"0 0 0",  fov:"55", squarePixels:"true" });
					...
					else if (player_table[2][0] == "50")
					{
						...
						{	
							...
							$.CreatePanelWithProperties("DOTAParticleScenePanel", playerPortrait, "RevengeTargetFrame", { style: "width:100%;height:100%;"+ "wash-color:"+color, particleName: "particles/donate/gold_icon_white", particleonly:"true", startActive:"true", cameraOrigin:"0 0 165", lookAt:"0 0 0",  fov:"55", squarePixels:"true" });
						}
						...
						//$.CreatePanelWithProperties("DOTAParticleScenePanel", playerPortrait, "RevengeTargetFrame", { style: "width:100%;height:100%;", particleName: "particles/donate/gold_icon_bp_rainbow.vpcf", particleonly:"true", startActive:"true", cameraOrigin:"0 0 165", lookAt:"0 0 0",  fov:"55", squarePixels:"true" });
					}
