function setupTooltip(){
    ...
    if($("#cam")==null)
    {
        $.CreatePanel("DOTAScenePanel", $("#toolpanel"), "cam", { style: "width:400px;height:400px;", particleonly: "false", map: "camera", camera: "camera"+num  });//unit='npc_dota_custom_creep_1_1'
